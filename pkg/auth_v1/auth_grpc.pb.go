...
func (c *authClient) GetUser(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetUserResponse, error) {
...
func (UnimplementedAuthServer) GetUser(context.Context, *emptypb.Empty) (*GetUserResponse, error) {
